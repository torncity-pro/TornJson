...
namespace TornJson.UserData
{
    public class PersonalStats
    {
        ...
        [JsonProperty("networthbank")] public long NetworthBank { get; set; }
        [JsonProperty("networthbazaar")] public long NetworthBazaar { get; set; }
        [JsonProperty("networthbookie")] public long NetworthBookie { get; set; }
        [JsonProperty("networthcayman")] public long NetworthCayman { get; set; }
        [JsonProperty("networthcompany")] public long NetworthCompany { get; set; }
        [JsonProperty("networthdisplaycase")] public long NetworthDisplayCase { get; set; }
        [JsonProperty("networthitems")] public long NetworthItems { get; set; }
        [JsonProperty("networthloan")] public long NetworthLoan { get; set; }
        [JsonProperty("networthpending")] public long NetworthPending { get; set; }
        [JsonProperty("networthpiggybank")] public long NetworthPiggyBank { get; set; }
        [JsonProperty("networthpoints")] public long NetworthPoints { get; set; }
        [JsonProperty("networthproperties")] public long NetworthProperties { get; set; }
        [JsonProperty("networthstockmarket")] public long NetworthStockMarket { get; set; }
        [JsonProperty("networthunpaidfees")] public long NetworthUnpaidFees { get; set; }
        [JsonProperty("networthvault")] public int NetworthVault { get; set; }
        [JsonProperty("networthwallet")] public long NetworthWallet { get; set; }

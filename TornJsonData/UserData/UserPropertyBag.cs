...
namespace TornJsonData.UserData
{
    public class UserPropertyBag : PropertyBagBase
    {
        ...
        public List<int> HonorsAwarded { get; private set; }

        [JsonProperty("honors_time")]
        public List<int> HonorsTime { get; private set; }

        [JsonProperty("medals_awarded")]
        public List<int> MedalsAwarded { get; private set; }

        [JsonProperty("medals_time")]
        public List<int> MedalsTime { get; private set; }

        [JsonProperty("display")]
        public List<DisplayCaseItem> DisplayCase { get; private set; }

        [JsonProperty("inventory")]
        public List<InventoryItem> Inventory { get; private set; }

        [JsonProperty("bazaar")]
        public List<BazaarItem> Bazaar { get; private set; }
        ...
        public Dictionary<string, string> BasicIcons { get; private set; }
        ...
        public List<string> JobPerks { get; private set; }

        [JsonProperty("property_perks")]
        public List<string> PropertyPerks { get; private set; }

        [JsonProperty("stock_perks")]
        public List<string> StockPerks { get; private set; }

        [JsonProperty("merit_perks")]
        public List<string> MeritPerks { get; private set; }

        [JsonProperty("education_perks")]
        public List<string> EducationPerks { get; private set; }

        [JsonProperty("enhancer_perks")]
        public List<string> EnhancerPerks { get; private set; }

        [JsonProperty("company_perks")]
        public List<string> CompanyPerks { get; private set; }

        [JsonProperty("faction_perks")]
        public List<string> FactionPerks { get; private set; }

        [JsonProperty("book_perks")]
        public List<string> BookPerks { get; private set; }
        ...
        public List<int> EducationCompleted { get; private set; }
        ...
        public List<WeaponExp> WeaponExp { get; private set; }
    }
}
